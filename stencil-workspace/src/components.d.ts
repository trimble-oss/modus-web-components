...
import { ModusTableColumn, ModusTableDisplayOptions, ModusTableLink, ModusTablePanelOptions, ModusTableSortingState } from "./components/modus-table/models";
...
declare namespace LocalJSX {
    ...
    interface ModusTable {
         ...
         */
        "onLinkClick"?: (event: ModusTableCustomEvent<ModusTableLink>) => void;
        /**
