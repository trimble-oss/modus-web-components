...
export const IconThumbsDownOutlined: FunctionalComponent<IconProps> = (props: IconProps) => (
  <svg
    class={`icon-thumbs-down-outlined ${props.pressed ? 'pressed' : ''}`}
    width={props.size ?? '14'}
