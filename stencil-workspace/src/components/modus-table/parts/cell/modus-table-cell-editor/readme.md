...
| ------------------------- | ----------- | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `args`                    | --          |             | `({ format: string; isCellDisabled?: (row: unknown) => boolean; }) \| ({ options: unknown[]; optionsDisplayProp?: string; placeholder?: string; isCellDisabled?: (row: unknown) => boolean; })` | `undefined` |
