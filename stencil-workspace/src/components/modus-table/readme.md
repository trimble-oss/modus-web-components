...
| `overflowMenuActions`  | --                        | (Optional) Dropdown menu with actions for each row.                                                                                 | `ModusTableRowAction[]`                | `[]`                                                      |
...
| `overflowMenuActionClick` | An event that fires when a overflow menu action is clicked. | `CustomEvent<ModusTableRowActionClickEvent>` |
