...
| ------------------- | --------------------- | --------------------------------------------------------------------------------------------------------------------- | --------------------- | ----------- |
| `allowedCharsRegex` | `allowed-chars-regex` | (optional) Custom regex for allowing characters while typing the input. Override it with '.*' to allow any character. | `string`              | `undefined` |
