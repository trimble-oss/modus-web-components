...
| ------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----------- |
| `allowedCharsRegex` | --                   | (optional) Regular expression to allow characters while typing the input. Default is /[0-9AaPpMm:\s]+/ or /[0-9:]+/ based on the display format. | `RegExp`              | `undefined` |
