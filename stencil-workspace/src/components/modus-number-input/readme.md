...
| `digitGroupSpacing`   | `digit-group-spacing`   | (optional) The digit group spacing.                           | `NumeralThousandGroupStyles` | `undefined` |
...
| `isCreditCard`        | `is-credit-card`        | (optional) Whether the input is a credit card.                | `boolean`                    | `undefined` |
