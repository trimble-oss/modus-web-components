...
| `currencySymbol`      | `currency-symbol`       | (optional) The currency symbol.                               | `string`                                                                                                                                      | `''`        |
| `decimalCharacter`    | `decimal-character`     | (optional) The decimal character.                             | `"," \| "."`                                                                                                                                  | `'.'`       |
| `decimalPlaces`       | `decimal-places`        | (optional) The number of decimal places.                      | `number`                                                                                                                                      | `2`         |
| `digitGroupSeparator` | `digit-group-separator` | (optional) The digit group separator.                         | `" " \| "," \| "."`                                                                                                                           | `','`       |
| `digitGroupSpacing`   | `digit-group-spacing`   | (optional) The digit group spacing.                           | `NumeralThousandGroupStyles.LAKH \| NumeralThousandGroupStyles.NONE \| NumeralThousandGroupStyles.THOUSAND \| NumeralThousandGroupStyles.WAN` | `undefined` |
...
| `integerLimit`        | `integer-limit`         | (optional) The maximum number of integers allowed.            | `number`                                                                                                                                      | `undefined` |
