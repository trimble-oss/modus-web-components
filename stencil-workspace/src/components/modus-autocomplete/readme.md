...
| `getFilteredOptions`        | --                              | A promise that returns the filtered options.                                                                           | `(search: string) => Promise<ModusAutocompleteOption[]>`                      | `undefined`                                   |
...
| `options`                   | --                              | The autocomplete's options.                                                                                            | `ModusAutocompleteOption[] \| Promise<ModusAutocompleteOption[]> \| string[]` | `undefined`                                   |
