...
| `filterOptions`             | --                              | A promise that returns the filtered options.                                                                           | `(search: string) => Promise<ModusAutocompleteOption[] \| string[]>`                                                                                                                                         | `undefined`                                   |
...
| `position`                  | `position`                      | (optional) The placement of the options                                                                                | `"auto" \| "auto-end" \| "auto-start" \| "bottom" \| "bottom-end" \| "bottom-start" \| "left" \| "left-end" \| "left-start" \| "right" \| "right-end" \| "right-start" \| "top" \| "top-end" \| "top-start"` | `'bottom-start'`                              |
