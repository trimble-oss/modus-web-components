      ...
      <mock:shadow-root>
        <div class="autocomplete medium">
          <div class="chips-container">
            ...
            <modus-text-input aria-autocomplete="list" aria-controls="${listId}" class="input" part="input-container " role="combobox" autocomplete="off" size="medium" type="search"></modus-text-input>
          </div>
