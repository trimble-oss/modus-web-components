...
export const IconDelete: FunctionalComponent<IconProps> = (props: IconProps) => (
  <svg class="icon-delete" xmlns="http://www.w3.org/2000/svg" fill={props.color} height={props.size ?? 16} width={props.size ?? 216} onClick={props.onClick} viewBox="0 0 32 32">
