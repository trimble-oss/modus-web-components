...
export const IconCopy: FunctionalComponent<IconProps> = (props: IconProps) => (
  <svg class="icon-copy" height={props.size ?? 16} width={props.size ?? 16} onClick={props.onClick ? (event) => props.onClick(event) : null} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
