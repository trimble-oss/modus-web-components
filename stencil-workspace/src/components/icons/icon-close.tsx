...
export const IconClose: FunctionalComponent<IconProps> = (props: IconProps) => (
  <svg class="icon-close" height={props.size ?? 16} width={props.size ?? 16} onClick={props.onClick ? () => props.onClick() : null} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
