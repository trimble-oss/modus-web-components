  ...
  it('renders', async () => {
    ...
    expect(root).toEqualHtml(`
      <modus-button button-style="fill" color="primary">
        <mock:shadow-root>
          <button class="size-medium color-primary style-fill" type="button"  style="--progress-width: 0%;">
            <span class="label">
               <slot></slot>
            </span>
          </button>
  ...
  it('renders icon only', async () => {
    ...
    expect(root).toEqualHtml(`
      <modus-button button-style="fill" color="primary" icon-only="add">
        <mock:shadow-root>
          <button class="color-primary icon-only size-medium style-fill" type="button" style="--progress-width: 0%;">
            <span class="icon">
