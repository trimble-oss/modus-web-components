    ...
    expect(root).toEqualHtml(`
      <modus-sentiment-scale type="thumbs">
        <mock:shadow-root>
          ...
          <div aria-checked="false" aria-label="Helpful" class="thumbs-container" role="button" tabindex="0">
           ...
           <div aria-checked="false" aria-label="Not helpful" class="thumbs-container" role="button" tabindex="0">
