...
| ---------------------- | ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- | ----------- |
| `apps`                 | --                       | (optional) The apps to render in the apps menu.                                                                                                                                         | `ModusFloatingNavbarApp[]`        | `undefined` |
...
| `logoOptions`          | --                       | (optional) Set the primary logo to display when the screen size is greater than 576 pixels, and the secondary logo to display when the screen size is less than or equal to 576 pixels. | `ModusFloatingNavbarLogoOptions`  | `undefined` |
| `profileMenuOptions`   | --                       | (required) Profile menu options.                                                                                                                                                        | `ModusFloatingProfileMenuOptions` | `undefined` |
| `reverse`              | `reverse`                | (optional) Whether to display the navbar items in reverse order.                                                                                                                        | `boolean`                         | `undefined` |
| `searchTooltip`        | --                       | (optional) Search tooltip.                                                                                                                                                              | `ModusFloatingNavbarTooltip`      | `undefined` |
...
| ------------------------- | ----------------------------------------------------------------------- | -------------------------------------------------- |
| `appsMenuAppOpen`         | An event that fires when an apps menu app opens.                        | `CustomEvent<ModusFloatingNavbarApp>`              |
...
- [modus-floating-navbar-search-overlay](search-overlay)
- [modus-floating-navbar-main-menu](main-menu)
- [modus-tooltip](../modus-tooltip)
- [modus-floating-navbar-notifications-menu](notifications-menu)
- [modus-floating-navbar-apps-menu](apps-menu)
- [modus-floating-navbar-profile-menu](profile-menu)
- [modus-dropdown](../modus-dropdown)
- [modus-floating-navbar-button-menu](button-menu)
...
graph TD;
  ...
  modus-floating-navbar --> modus-tooltip
  modus-floating-navbar --> modus-floating-navbar-notifications-menu
  modus-floating-navbar --> modus-floating-navbar-apps-menu
  modus-floating-navbar --> modus-floating-navbar-profile-menu
  modus-floating-navbar --> modus-dropdown
  modus-floating-navbar --> modus-floating-navbar-button-menu
  modus-floating-navbar-search-overlay --> modus-text-input
  style modus-floating-navbar fill:#f9f,stroke:#333,stroke-width:4px
```
