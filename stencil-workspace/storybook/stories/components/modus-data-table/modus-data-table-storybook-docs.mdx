...
- Users can change page size and page number using keyboard navigation. 
- The Tab key brings focus to an element and the Enter key is used to perform an action like selecting a page size and page number.