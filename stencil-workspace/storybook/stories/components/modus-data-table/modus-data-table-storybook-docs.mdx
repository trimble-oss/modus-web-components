...
User can opt for this expanding rows.

<Story id="components-data-table--expandable-rows" height={'480px'} />
...
| `summaryRow`          | `summary-row`             | (optional) To display summary row in table. Which can be used to display total. | `boolean`                | `false`      |
