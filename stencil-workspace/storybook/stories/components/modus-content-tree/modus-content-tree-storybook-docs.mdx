...
<modus-tree-view
  ...
  size=""
  class="hydrated">
  <modus-tree-view-item node-id="1" label="Inbox" class="hydrated" show-action-bar="true"></modus-tree-view-item>
</modus-tree-view>
```
...
| showActionBar    | Allows the item to show an action bar            | boolean |
