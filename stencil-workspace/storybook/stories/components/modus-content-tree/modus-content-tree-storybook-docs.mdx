...
| itemChange      | Fired when an multiple items is selected using keyboard                                                                               | `CustomEvent<{isSelected: boolean, itemId: number}>` |
...
| itemChange       | An event that fires on tree item click                                                | `CustomEvent<{isSelected: boolean, itemId: number}>` |
