...
<modus-modal
  ...
  outline-button-aria-label="Okay">>
...
| `secondaryButtonText`      | `secondary-button-text`       | (optional) The modal's secondary button text.
| `outlineButtonAriaLabel`   | `outline-button-aria-label`   | (optional) The modal's outline button aria-label.                                                                                                       | `string`                        | `undefined` |
| `outlineButtonDisabled`    | `outline-button-disabled`     | (optional) Disable outline button.                                                                                                                      | `boolean`                       | `undefined` |
| `outlineButtonText`        | `outline-button-text`         | (optional) The modal's outline button text.                                                                                                             | `string`                        | `undefined` |
...
- When Outline button has focus, **Enter** emits `outlineButtonClick` event.
