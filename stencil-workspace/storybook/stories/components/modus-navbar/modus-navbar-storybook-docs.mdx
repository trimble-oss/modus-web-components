...
| `showAdd`              | `show-add`               | (optional) Whether to show add (plus icon).                      | `boolean`                                                                                                            | `undefined` |
...
| `showSearch`           | `show-search`            | (optional) Whether to show search.                               | `boolean`                                                                                                            |
...
| ------------------------- | ------------------------------------------------------ | ----------------------------------------- |
| `addMenuOpen`             | An event that fires on add(plus) menu click.           | `CustomEvent<void>`                       |
