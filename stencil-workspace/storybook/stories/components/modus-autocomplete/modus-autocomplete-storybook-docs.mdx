...
<Story id="user-inputs-autocomplete--multiple-selection" />
...
<Story id="user-inputs-autocomplete--with-new-options" />

### With Dynamic Options

<Story id="user-inputs-autocomplete--with-dynamic-options" />
...
<div style="width: 500px">
  ...
  <!-- With New Options -->
  <modus-autocomplete id="new-options" label="New Options" placeholder="Search..."></modus-autocomplete>
...
<script>
  ...
  const withNewOptions = document.querySelector('#new-options');
  const newOptions = ['Cranberry', 'Fig', 'Pomegranate'];
  if (withNewOptions) {
...
| --------------------------- | ------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- | --------------------------------------------- | ----------- |
| `additionalOptions`         | --                              | The autocomplete's additional options.                                                                                 | `ModusAutocompleteOption[]`                             | `undefined`                                   |
...
| `filterOptions`             | `filter-options`                | The autocomplete's filter options function.                                                                            | `(value: string) => Promise<ModusAutocompleteOption[]>` | `undefined`                                   |
