...
| `options`                   | `options`                       | The autocomplete's options.                                                                                            | `"ModusAutocompleteOption[]" \| "string[]"`                                                                                                                                                                     | `undefined`                                   |
| `position`                  | `position`                      | (optional) The placement of the options.                                                                               | `"auto" \| "auto-start" \| "auto-end" \| "top-start" \| "top-end" \| "bottom-start" \| "bottom-end" \| "right-start" \| "right-end" \| "left-start" \| "left-end" \| "top" \| "left" \| "bottom" \| "right" | `bottom-start`                                |
