...
```html
<div id="container" style="display:flex; min-height:500px; overflow:hidden; position: relative; box-shadow: 0 0 2px var(--modus-secondary)!important;">

<modus-utility-panel target-content="#panelcontent" expanded=${expanded} push-content=${pushContent} target-content=${targetContent}>
