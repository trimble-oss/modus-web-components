      ...
      sidenav.data=[
          {
            ...
            onSideNavItemSelected: (e)=>{
              executeListener(e, () => displayContent(e.detail ? 'home-menu' : null));
            },
          ...
          },
          {
            id:'usage-menu',
            onSideNavItemSelected: (e)=>{
              executeListener(e, () => displayContent(e.detail ? 'usage-menu' : null));
            },
          ...
          },
          {
            id:'styles-menu',
            onSideNavItemSelected: (e)=>{
              executeListener(e, () => displayContent(e.detail ? 'styles-menu' : null));
            },
          ...
          },
          {
            ...
            onSideNavItemSelected: (e)=>{
              executeListener(e, () => displayContent(e.detail ? 'accessibility-menu' : null));
            },
