...
<nav style="display:flex; width: 100%;align-items: center;height: 56px;box-shadow: 0 0 2px var(--modus-border-color)!important;">
  ...
  <img  style="filter:var(--modus-navbar-brand-logo-filter);"  height='24' src="https://modus.trimble.com/img/trimble-logo.svg" alt="Modus navbar product logo" />
</nav>
    ...
    function addEventHandlers(){
      ...
      Array.from(getRoot().querySelectorAll('modus-side-navigation-item')).forEach(c => {
        c.addEventListener('sideNavItemSelected', function callbackfn(e){
          executeListener(e, () => displayContent(e.detail.selected ? e.detail.id : null));
        });
      });
    }
      ...
      sidenav.data=[
          {
            ...
            onSideNavItemSelected: (e)=>{
              executeListener(e, () => displayContent(e.detail.selected ? 'home-menu' : null));
            },
          ...
          },
          {
            id:'usage-menu',
            onSideNavItemSelected: (e)=>{
              executeListener(e, () => displayContent(e.detail.selected ? 'usage-menu' : null));
            },
            menuIconUrl: "data:image/svg+xml, %3Csvg xmlns='http://www.w3.org/2000/svg' slot='menu-icon' fill='currentColor' height='24' width='24' viewBox='0 0 32 32'%3E%3Cpath d='M16 3C11.184 3 6 4.252 6 7v18c0 2.748 5.184 4 10 4s10-1.252 10-4V7c0-2.748-5.184-4-10-4zm0 2c5.249 0 8 1.486 8 2s-2.751 2-8 2c-5.25 0-8-1.486-8-2s2.75-2 8-2zm0 22c-5.25 0-8-1.486-8-2v-3.476C9.95 22.525 13.041 23 16 23s6.05-.475 8-1.476V25c0 .514-2.751 2-8 2zm0-6c-5.25 0-8-1.486-8-2v-3.476C9.95 16.525 13.041 17 16 17s6.05-.475 8-1.476V19c0 .514-2.751 2-8 2zm0-6c-5.25 0-8-1.486-8-2V9.524C9.95 10.525 13.041 11 16 11s6.05-.475 8-1.476V13c0 .514-2.751 2-8 2z' /%3E%3C/svg%3E",
            label: 'Usage page 2'
          },
          {
            id:'styles-menu',
            onSideNavItemSelected: (e)=>{
              executeListener(e, () => displayContent(e.detail.selected ? 'styles-menu' : null));
            },
          ...
          },
          {
            ...
            onSideNavItemSelected: (e)=>{
              executeListener(e, () => displayContent(e.detai.selected ? 'accessibility-menu' : null));
            },
            menuIconUrl: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' slot='menu-icon' fill='currentColor' height='24' width='24' viewBox='0 0 32 32'%3E%3Cstyle%3E .st1 %7B stroke: %23000; stroke-miterlimit: 10; %7D %3C/style%3E%3Cpath d='M25.659 17.274c.056-.422.085-.848.087-1.274a10.145 10.145 0 0 0-.087-1.274l2.743-2.145a.656.656 0 0 0 .156-.832l-2.6-4.498a.653.653 0 0 0-.793-.286l-3.237 1.3a9.497 9.497 0 0 0-2.197-1.274l-.494-3.445A.633.633 0 0 0 18.6 3h-5.2a.634.634 0 0 0-.637.546l-.49 3.445a9.989 9.989 0 0 0-2.197 1.274l-3.237-1.3a.634.634 0 0 0-.793.286l-2.6 4.498a.641.641 0 0 0 .156.832l2.739 2.145c-.057.422-.087.848-.091 1.274.004.426.034.852.091 1.274l-2.743 2.145a.656.656 0 0 0-.156.832l2.6 4.498c.16.276.494.397.793.286l3.237-1.3c.672.521 1.41.95 2.197 1.274l.494 3.445c.044.317.317.55.637.546h5.2c.32.005.593-.23.637-.546l.494-3.445a9.985 9.985 0 0 0 2.197-1.274l3.237 1.3c.299.12.64-.003.793-.286l2.6-4.498a.656.656 0 0 0-.156-.832l-2.743-2.145zM16 20c-2.206 0-4-1.794-4-4s1.794-4 4-4 4 1.794 4 4-1.794 4-4 4z' /%3E%3C/svg%3E",
            label: 'Accessibility page 2'
          },
        ];
    }
