...
```html
<modus-progress-bar value="3" max-value="4" min-value="0" text="75%"></modus-progress-bar> <modus-progress-bar value="3" max-value="4" min-value="0" size="compact"></modus-progress-bar>
```
