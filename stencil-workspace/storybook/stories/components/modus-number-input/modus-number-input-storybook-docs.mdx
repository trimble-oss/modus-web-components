...
| `decimalPlaces`       | `decimal-places`        | (optional) The number of decimal places.             | `number`                                  | `undefined` |
| `digitGroupSeparator` | `digit-group-separator` | (optional) The digit group separator.                | `' ' \| ',' \| '.'`                       | `','`       |
| `digitGroupSpacing`   | `digit-group-spacing`   | (optional) The digit group spacing.                  | `'lakh' \| 'none' \| 'thousand' \| 'wan'` | `'none'`    |
...
| `isCreditCard`        | `is-credit-card`        | (optional) Whether the input is a credit card.       | `boolean`                                 | `false`     |
