...
<modus-checkbox small></modus-checkbox><br />
<modus-checkbox disabled small></modus-checkbox><br />
<modus-checkbox label="Checkbox" small></modus-checkbox><br />
<modus-checkbox disabled label="Checkbox" small></modus-checkbox><br />
<modus-checkbox checked disabled label="Checkbox" small></modus-checkbox><br />

<Anchor storyId="user-inputs-checkbox--indeterminate" />

### Indeterminate

<modus-checkbox indeterminate small></modus-checkbox>
...
<modus-checkbox small></modus-checkbox>
<modus-checkbox disabled small></modus-checkbox>
<modus-checkbox label="Checkbox" small></modus-checkbox>
<modus-checkbox disabled label="Checkbox" small></modus-checkbox>
<modus-checkbox checked disabled label="Checkbox" small></modus-checkbox>
...
| `small` | `small` | (optional) Whether the checkbox should be displayed in small size. | `boolean`          | `false` |
