...
Each character as shown in the table below can be used for representing the date and any character can be used as a separator except for those in regular expressions.
