...
Scrollbar is used to perform operations like scrolling through the content of a scrollable container, when it exceeds the available space.

<Story id="components-table--scrollbar" height={'480px'} />
...
| `scrollbarHeight`     | `scrollbar-height`        | (Optional) (Optional) To control scrollbar height of table.                                                 | `string`                      | `undefined`  |
