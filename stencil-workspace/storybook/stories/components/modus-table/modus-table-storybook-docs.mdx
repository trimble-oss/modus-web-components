...
| `displayOptions`          | --                        | (Optional) To control display options of table.                                                                                                                                               | `ModusTableDisplayOptions`             | <code>\{     borderless: false,     cellBorderless: false,     cellVerticalBorderless:false,   \}</code> |
