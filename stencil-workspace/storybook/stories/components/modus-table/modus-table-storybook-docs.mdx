...
<Story id="components-table--value-formatter" height={'370px'} />

### Cell Renderer

<Story id="components-table--cell-renderer" height={'370px'} />
...
interface ModusTableLink {
  display: string;
  url: string;
}

interface ModusTableBadge {
  color?: ModusTableBadgeColor;
  text: string;
  type?: ModusTableBadgeType;
}

enum ModusTableBadgeColor {
  Danger = 'danger',
  Dark = 'dark',
  Primary = 'primary',
  Secondary = 'secondary',
...
enum ModusTableBadgeType {
  Counter = 'counter',
  Default = 'default',
  Text = 'text',
}

interface ModusTableColumnVisibility {
  title: string;
...
| `linkClick`  | An event that fires on click of the link. | `[{ display: string, url: string }]` |
