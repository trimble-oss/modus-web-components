...
<modus-accordion>
  ...
  <modus-accordion-item disabled header-text="Item 3" icon="notifications">Content</modus-accordion-item>
</modus-accordion>

### Circle Arrow

<modus-accordion>
  <modus-accordion-item header-text="Item 1" size="condensed" expand-button-type="circleArrow">Content</modus-accordion-item>
  <modus-accordion-item header-text="Item 2" size="condensed" expand-button-type="circleArrow">Content</modus-accordion-item>
  <modus-accordion-item disabled expanded header-text="Item 3" size="condensed" expand-button-type="circleArrow">Content</modus-accordion-item>
</modus-accordion>
