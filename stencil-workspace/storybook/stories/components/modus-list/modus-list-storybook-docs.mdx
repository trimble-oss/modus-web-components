...
<modus-list>
  ...
  <modus-list-item type="icon" icon="moon">
      Icon
  </modus-list-item>
</modus-list>
...
<modus-list>
  ...
  <modus-list-item type="icon" icon="moon">Icon</modus-list-item>
</modus-list>
```
...
<section>
  <table>
    ...
    <tbody>
     <tr>
        <td>borderless</td>
        <td>Removes border from list item</td>
        <td>boolean</td>
        <td></td>
        <td></td>
        <td></td>
      ...
      <tr>
        <td>icon</td>
        <td>Name of the icon to render</td>
        <td>string</td>
        <td></td>
        <td></td>
        <td></td>
      ...
      <tr>
        <td>Type</td>
        <td>The type of list item to render</td>
        <td>string</td>
        <td>'standard', 'icon</td>
        <td>'standard'</td>
        <td></td>
