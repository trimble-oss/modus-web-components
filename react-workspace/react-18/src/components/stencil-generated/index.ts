...
export const ModusDateInput = /*@__PURE__*/createReactComponent<JSX.ModusDateInput, HTMLModusDateInputElement>('modus-date-input');
...
export const ModusFloatingNavbar = /*@__PURE__*/createReactComponent<JSX.ModusFloatingNavbar, HTMLModusFloatingNavbarElement>('modus-floating-navbar');
export const ModusFloatingNavbarAppsMenu = /*@__PURE__*/createReactComponent<JSX.ModusFloatingNavbarAppsMenu, HTMLModusFloatingNavbarAppsMenuElement>('modus-floating-navbar-apps-menu');
export const ModusFloatingNavbarButtonMenu = /*@__PURE__*/createReactComponent<JSX.ModusFloatingNavbarButtonMenu, HTMLModusFloatingNavbarButtonMenuElement>('modus-floating-navbar-button-menu');
export const ModusFloatingNavbarMainMenu = /*@__PURE__*/createReactComponent<JSX.ModusFloatingNavbarMainMenu, HTMLModusFloatingNavbarMainMenuElement>('modus-floating-navbar-main-menu');
export const ModusFloatingNavbarNotificationsMenu = /*@__PURE__*/createReactComponent<JSX.ModusFloatingNavbarNotificationsMenu, HTMLModusFloatingNavbarNotificationsMenuElement>('modus-floating-navbar-notifications-menu');
export const ModusFloatingNavbarProfileMenu = /*@__PURE__*/createReactComponent<JSX.ModusFloatingNavbarProfileMenu, HTMLModusFloatingNavbarProfileMenuElement>('modus-floating-navbar-profile-menu');
export const ModusFloatingNavbarSearchOverlay = /*@__PURE__*/createReactComponent<JSX.ModusFloatingNavbarSearchOverlay, HTMLModusFloatingNavbarSearchOverlayElement>('modus-floating-navbar-search-overlay');
export const ModusIcon = /*@__PURE__*/createReactComponent<JSX.ModusIcon, HTMLModusIconElement>('modus-icon');
...
export const ModusNavbarButtonMenu = /*@__PURE__*/createReactComponent<JSX.ModusNavbarButtonMenu, HTMLModusNavbarButtonMenuElement>('modus-navbar-button-menu');
