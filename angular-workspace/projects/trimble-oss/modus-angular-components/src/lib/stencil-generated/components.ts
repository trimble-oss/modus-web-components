...
@ProxyCmp({
  inputs: ['columnResize', 'columns', 'data', 'displayOptions', 'fullWidth', 'hover', 'pageSizeList', 'pagination', 'panelOptions', 'showSortIconOnHover', 'showTablePanel', 'sort', 'summaryRow'],
