...
@ProxyCmp({
  inputs: ['columnReorder', 'columnResize', 'columns', 'data', 'displayOptions', 'fullWidth', 'hover', 'pageSizeList', 'pagination', 'panelOptions', 'showSortIconOnHover', 'showTablePanel', 'sort', 'summaryRow'],
