...
| `errorText`         | `error-text`          | (optional) The error state text.                     | `string`              | `undefined` |
| `helperText`        | `helper-text`         | (optional) The helper text displayed below the input | `string`              | `undefined` |
