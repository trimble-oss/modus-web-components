...
| ------------------- | --------------------- | ----------------------------------------------------- | --------- | ----------- |
| `clearable`         | `clearable`           | (optional) Whether the text input has a clear button. | `boolean` | `true`      |
| `disabled`          | `disabled`            | (optional) Whether the text input is disabled.        | `boolean` | `undefined` |
...
| `value`             | `value`               | (optional) The text input value.                      | `string`  | `undefined` |
...
| ------------- | ----------------------------------------------- | --------------------- |
| `valueChange` | An event that fires on text input value change. | `CustomEvent<string>` |
