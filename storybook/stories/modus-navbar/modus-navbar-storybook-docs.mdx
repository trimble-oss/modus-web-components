...
[Modus Navbar](https://modus.trimble.com/elements/navbar/) web components are the header of all Trimble applications. They are referenced using the `<modus-navbar>` custom HTML element.
