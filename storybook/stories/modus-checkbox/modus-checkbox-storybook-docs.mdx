...
[Modus Checkbox](https://modus.trimble.com/elements/checkboxes/) web components are wrappers around native `<input type="checkbox">` elements. They are referenced using the `<modus-checkbox>` custom HTML element.
