...
[Modus Badge](https://modus.trimble.com/elements/badges/) web components provide non-interactive labels for displaying small amounts of information. They are referenced using the `<modus-badge>` custom HTML element.
...
<modus-badge color="tertiary">Tertiary</modus-badge>
<modus-badge color="dark">Dark</modus-badge>
<bmodus-badge color="warning">Warning</bmodus-badge>
<modus-badge color="danger">Danger</modus-badge>
